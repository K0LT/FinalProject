                        ...
                        @if($exercise->pivot->target_number > 0)
                            <div class="pt-4 border-t border-gray-100">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-gradient-to-r from-green-500 to-emerald-500 h-2 rounded-full transition-all" style="width: {{ $exercise->pivot->compliance_rate ?? 0 }}%"></div>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="pt-4 border-t border-gray-100">
                                ...
                                <p class="text-gray-900">
                                    ...
                                    <span class="text-gray-600 text-sm">
                                        (há {{ \Carbon\Carbon::parse($exercise->pivot->last_performed)->diffForHumans() }})
                                    </span>
                                </p>
                            </div>
                        @endif
