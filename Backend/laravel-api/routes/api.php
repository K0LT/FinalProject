...
Route::put('conditions/{condition}', [\App\Http\Controllers\ConditionController::class, 'update']);
//DailyNutritions
...
Route::put('daily_nutritions/{daily_nutrition}', [\App\Http\Controllers\DailyNutritionController::class, 'update']);
//Diagnostics
...
Route::put('diagnostics/{diagnostic}', [\App\Http\Controllers\DiagnosticController::class, 'update']);
//Exercises
...
Route::put('exercises/{exercise}', [\App\Http\Controllers\ExerciseController::class, 'update']);
//ExercisesPatients
...
Route::put('exercise_patients/{exercise_patient}', [\App\Http\Controllers\ExercisePatientController::class, 'update']);
//GoalMilestones
...
Route::put('goal_milestones/{goal_milestone}', [\App\Http\Controllers\GoalMilestoneController::class, 'update']);
//NutritionalGoals
...
Route::put('nutritional_goals/{nutritional_goal}', [\App\Http\Controllers\NutritionalGoalController::class, 'update']);
//Patients
