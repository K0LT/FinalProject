            ...
            <div className="max-w-[1200px] mx-auto px-4">
                <div className="grid grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h2 className="text-4xl font-normal mb-6 text-gray-900 leading-tight">
                        ...
                        <div className="flex items-center gap-4">
                            <button className="inline-flex items-center justify-center gap-2 text-sm font-medium transition-colors bg-primary text-white hover:bg-primary/90 h-[40px] rounded-sm px-6 shadow-sm">
                    ...
                    <div className="relative">
                        ...
                        <img
                            ...
                            className="relative rounded-2xl shadow-2xl w-[600px] h-[500px] object-cover"
                        />
                        <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium text-gray-900">4.9/5 (127 avaliações)</span>
                            </div>
                        </div>
                    </div>
                </div>
