...
const LoginHeader = () => {
    ...
    return (
        <header className="border-b bg-white/80 backdrop-blur-sm">
            <div className="container mx-auto px-4 py-4">
                <div className="flex items-center justify-between">
                    <button
                        ...
                        className="flex items-center gap-2 justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all
                            ...
                            >
                                ...
                                <defs>
                                    <radialGradient id="premiumGradient" cx="30%" cy="30%">
                                        <stop offset="0%" stopColor="#FFD700" stopOpacity="0.9"></stop>
                                        <stop offset="100%" stopColor="#B8860B" stopOpacity="1"></stop>
                                    </radialGradient>
                                </defs>
            ...
            hover:text-accent-foreground h-9 px-4 py-2 has-[>svg]:px-3"
                    >
                        Registar-me
                    </Link>
                </div>
