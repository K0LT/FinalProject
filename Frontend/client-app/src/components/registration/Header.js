                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 relative flex items-center justify-center">
                            <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="50" cy="50" r="48" fill="#B8860B" stroke="#996F00" strokeWidth="2" className="drop-shadow-lg" />
                                <defs>
                                ...
                                <g fill="white" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M 28 25 L 72 25" strokeWidth="2.5" opacity="0.95" />
                                    <path d="M 50 25 L 50 75" strokeWidth="2" opacity="0.9" />
                                    <path d="M 32 35 Q 38 40 32 45 Q 26 50 32 55" fill="none" strokeWidth="2" opacity="0.85" />
                                    <path d="M 68 35 Q 62 40 68 45 Q 74 50 68 55" fill="none" strokeWidth="2" opacity="0.85" />
                                    <path d="M 42 40 Q 50 35 58 40 Q 50 50 42 40" fill="none" strokeWidth="1.8" opacity="0.8" />
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Registo de Paciente</p>
                        </div>
                    </div>
