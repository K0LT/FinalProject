        ...
        <section className="py-20 bg-gradient-to-r from-primary to-red-600 text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl lg:text-5xl mb-6">Muda o teu corpo e a tua vida com José Machado</h2>
                    <p className="text-lg lg:text-xl mb-12 opacity-90 max-w-3xl mx-auto">
                    ...
                    <div className="mb-16">
                        <h3 className="text-2xl lg:text-3xl mb-12">Como funciona o Programa de Transformação QiFlow</h3>
                        {/* Responsive grid: 1 column on mobile, 3 on medium+ */}
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-white/20">
                                ...
                                <h4 className="text-lg md:text-xl mb-4">1. Define o teu objetivo</h4>
                                <p className="opacity-90 text-sm md:text-base">Consulta personalizada para entender os teus objetivos, limitações e preferências únicas.</p>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-white/20">
                                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6">
                                ...
                                <h4 className="text-lg md:text-xl mb-4">2. Recebe o teu plano na área reservada</h4>
                                <p className="opacity-90 text-sm md:text-base">Plano de nutrição, exercício e acupunctura totalmente personalizado disponível 24/7.</p>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-white/20">
                                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6">
                                ...
                                <h4 className="text-lg md:text-xl mb-4">3. Acompanhamento contínuo</h4>
                                <p className="opacity-90 text-sm md:text-base">Suporte diário dos nossos especialistas, ajustes em tempo real e motivação constante.</p>
                            </div>
                        </div>
                    </div>

                    <div className="mb-12">
                        <h3 className="text-2xl lg:text-3xl mb-12">Porque é que o programa da QiFlow é diferente?</h3>
                        ...
                        <div className="flex flex-col md:flex-row justify-between gap-8 max-w-4xl mx-auto">
                            <div className="text-center flex-1 min-w-[250px]">
                                ...
                                <h4 className="text-xl lg:text-2xl mb-4">Personalização real</h4>
                                <p className="opacity-90 text-base lg:text-lg">Cada plano é único, baseado na medicina tradicional chinesa e nas tuas necessidades específicas.</p>
                            </div>
                            <div className="text-center flex-1 min-w-[250px]">
                                <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6">
                                ...
                                <h4 className="text-xl lg:text-2xl mb-4">Apoio constante</h4>
                                <p className="opacity-90 text-base lg:text-lg">Especialistas disponíveis todos os dias para te motivar e ajustar o teu programa.</p>
                            </div>
                            <div className="text-center flex-1 min-w-[250px]">
                                <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6">
                                ...
                                <h4 className="text-xl lg:text-2xl mb-4">Simplicidade total</h4>
                                <p className="opacity-90 text-base lg:text-lg">Tudo numa só plataforma. Fácil de seguir, fácil de manter, resultados garantidos.</p>
                            </div>
                        </div>
                    </div>

                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/20">
                        <h3 className="text-2xl lg:text-3xl mb-6">Pronto para começar?</h3>
                        <p className="text-lg lg:text-xl mb-8 opacity-90">Junta-te a centenas de pessoas que já transformaram as suas vidas com o programa QiFlow.</p>
                        {/* Responsive buttons: Stack vertically on mobile, row on small+ */}
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive h-10 rounded-md has-[>svg]:px-4 text-base lg:text-lg px-6 lg:px-8 bg-white text-primary hover:bg-gray-100">
