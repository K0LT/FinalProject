        ...
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row justify-center mx-auto max-w-[1000px] w-full gap-6 md:gap-0">
                    <div className="w-full md:w-1/3 bg-card text-card-foreground flex flex-col gap-6 rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-all">
                        ...
                        <button
                            ...
                            className="mt-auto inline-flex items-center justify-center gap-2 w-full border rounded-md text-sm font-medium px-4 py-2 hover:bg-accent hover:text-accent-foreground transition-all"
                        >
                            Saber Mais
                    ...
                    <div className="w-full md:w-1/3 bg-card text-card-foreground flex flex-col gap-6 rounded-xl border border-primary shadow-2xl relative p-6 md:scale-105">
                        ...
                        <button
                            onClick={() => router.push("/booking")}
                            className="mt-auto inline-flex items-center justify-center gap-2 w-full bg-primary text-primary-foreground hover:bg-primary/90 rounded-md text-sm font-medium px-4 py-2 transition-all"
                        >
                            Começar Agora
                            <ArrowRight className="w-4 h-4 ml-2" />
                        </button>
                ...
                <div className="text-center mt-12">
                    ...
                    <button
                        onClick={() => router.push("/booking")}
                        className="inline-flex items-center justify-center gap-2 text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 h-10 rounded-md px-6 transition-all"
                    >
